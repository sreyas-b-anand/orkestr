      ...
      <div className="flex gap-3 py-4 relative z-10">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
            <span className="text-sm font-bold text-foreground">Orkestr</span>
            {/* Verified badge */}
            ...
            <span className="text-sm text-muted-foreground">@orkestr_ai</span>
...
export function SocialThreadCard({ posts }: SocialThreadCardProps) {
  ...
  return (
    <div className="section-card overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {posts.length} post{posts.length !== 1 ? "s" : ""} · @orkestr_ai
            </p>
          </div>
        </div>
        <button
      ...
      <div className="px-6 divide-y divide-border/60">
        {posts.map((post, i) => (
          <Tweet key={i} post={post} index={i} total={posts.length} />
        ))}
      </div>
